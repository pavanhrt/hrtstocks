...
create table profiles (
  ...
  -- Identity Platform / Firebase UID; linked on first verified sign-in.
...
comment on table profiles is 'One row per authorized user (invite-only); carries the app-level role enforced server-side.';
...
-- ---------------------------------------------------------------------------
-- Strategy / rule / parameter registry (populated by services/pipeline/src/seed/seed-strategies.mjs
