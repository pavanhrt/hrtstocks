...
create table buy_setup_fifteen_minute_wave (
  ...
  reason text,
  source_locator text not null default 'services/pipeline/src/run-screening/buy-setup/fifteen-minute-wave.js (reuses features/wave.js GUE-IMPULSE-001/002/003)',
  computed_at timestamptz not null default now(),
