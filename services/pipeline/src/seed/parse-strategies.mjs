...
// Shared by seed-strategies.mjs (writes via pg, for re-seeding after a
...
// Repo root (strategies/, config/, fundamentals/). In a container the specs are copied
// next to the code: set SPEC_ROOT.
const ROOT = process.env.SPEC_ROOT ?? path.resolve(__dirname, "..", "..", "..", "..");
