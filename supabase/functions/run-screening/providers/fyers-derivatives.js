...
async function requestJson(url, supabase) {
 ...
 */
export async function fetchOptionChain(underlyingSymbol, strikeCount, supabase = null) {
  ...
  const body = await requestJson(url, supabase);
 ...
 * @param {import("@supabase/supabase-js").SupabaseClient} [supabase]
 */
export async function fetchFuturesChain(underlyingSymbol, supabase = null) {
 ...
 * @param {import("@supabase/supabase-js").SupabaseClient} [supabase]
 */
export async function fetchMarketDepth(symbol, supabase = null) {
